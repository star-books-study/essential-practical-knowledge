...
>   - 파일 시스템 / 네트워크 (HTTP 요청, DB 쿼리, API 호출), 키보드 입력 대기 등
...
> - 동기/비동기는 요청한 작업에 대해 **완료 여부를 신경 써서 작업을 순차적으로 수행할지 아닌지**에 대한 관점
> - 블로킹/논블로킹 : **현재 작업이 block(차단, 대기) 되느냐 아니냐**에 따라 다른 작업을 수행할 수 있는지에 대한 관점